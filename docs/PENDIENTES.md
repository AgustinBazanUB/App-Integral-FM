# Datos y credenciales pendientes

## Negocio

- Precios, stock web y variantes confirmadas.
- Dirección, teléfono, email, horarios y condiciones comerciales.
- Regla de reserva/descuento de stock para pedidos web.
- Política de envíos, retiro, cambios y facturación.
- Costos, márgenes, impuestos y puntos de venta validados.
- Responsables, roles definitivos y ubicaciones asignadas.

## Integraciones

- Proveedor de pagos y credenciales de backend.
