...
export default function CustomerImportModal({ open, onClose, profile, zones, onImported }) {
  ...
  const confirmImport = async () => {
    ...
    try {
      for (let index = 0; index < pending.length; index += 1) {
        ...
        // Revalidación justo antes de escribir: evita pisar un cliente que haya sido
        // creado por otra pestaña/usuario después de la vista previa.
  ...
  return (
    <Modal
      ...
      description="Acepta el archivo generado por Flor Mía WhatsApp Sender: Telefono, Nombre y Apellido, Zona."
      footer={footer}
    >
      <div className="fm-customer-import">
        <label className="fm-wa-file">
        ...
        {parsed.summary ? (
          <>
            ...
            <div className="fm-wa-validation">
            ...
            <div className="fm-wa-excel-preview" aria-label="Vista previa de clientes a importar">
              <table>
            ...
            {parsed.invalidRows.length ? (
              <div className="fm-wa-errors" role="alert">
